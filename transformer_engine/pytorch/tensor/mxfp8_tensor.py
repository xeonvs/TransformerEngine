...
class MXFP8Quantizer(Quantizer):
    ...
    def quantize_rowwise_transpose(
        ...
        *,
        ...
        tensor computed for ``tensor``. This emits the transposed row-wise
        payload directly from the high-precision source.
        """
        ...
        if self.dtype not in (DType.kFloat8E4M3, DType.kFloat8E5M2):
            raise TypeError(
